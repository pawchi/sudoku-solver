...
public class UserDialogs {
    private static final String msg = "Please write coordinates XY and value V in form three digits XYV (f.e.:357, from ranges X:0-8, Y:0-8, V:1-9)" +
            "\nor type:" +
            "\nSUDOKU to resolve sudoku or" +
            "\nEXIT to exit or" +
            "\nEXAMPLE to show example sudoku to solve.";
    ...
    public static UserEntry getSingleEntry() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Wrong selection! \nWatch out for the RANGE OF 'XYV' VALUES shown below!!\n");
            }
        }
    }
}
